...
public class AdminUnblockUserAction implements DatabaseAction {
    ...
    public Navigator execute(HttpServletRequest request) throws ActionException {
        ...
        User userToUnblock = userService.getUser(userId);
        if (user.getRole() == Role.ADMIN) {
            ...
            request.setAttribute(AttributeConstant.PROCESSING_USER, userToUnblock);
